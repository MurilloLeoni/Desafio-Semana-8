...
const Login = () => {
  return (
    <div className="flex items-center justify-center w-screen h-screen bg-[url('src/assets/images/bg-login.png')] bg-cover bg-center">
        <div className='border-none flex flex-col justify-center items-center text-center gap-6 p-7 rounded-[20px] text-white backdrop-blur bg-customColor md:w-[783px] md:h-[454px]'>
            ...
            <img src="src/assets/images/logo-compass-uol.png" alt="logo compass uol" className='w-80 h-28' />
        </div>
    </div>
  )
}
